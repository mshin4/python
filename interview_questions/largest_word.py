...
Note: You are provided an example of a short story in the code editor. The example story should not be part of your solution: it is just there to help you.
